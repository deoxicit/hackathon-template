...
export type { HackathonToken } from "./contracts/HackathonToken";
export { HackathonToken__factory } from "./factories/contracts/HackathonToken__factory";
export type { HackathonTemplate } from "./src/HackathonTemplate";
export { HackathonTemplate__factory } from "./factories/src/HackathonTemplate__factory";
